...
UniValue getrawtransaction(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            ...
            "       },\n"
            "       \"sequence\": n      (numeric) The script sequence number\n"
            "       \"value\": n         (numeric, optional) The value of the output being spent in " +
            CURRENCY_UNIT + "\n"
            ...
            CURRENCY_UNIT + "\n"
                            ...
                            "     ,...\n"
                            "  ],\n"
                            "  \"valueBalance\" : x.xxx,  (numeric, optional) The net value of Sapling Spends minus Outputs in " +
            CURRENCY_UNIT + "\n"
                            "  \"valueBalanceZat\" : n,   (numeric, optional) The net value of Sapling Spends minus Outputs in " +
            MINOR_CURRENCY_UNIT + "\n"
                                  ...
                                  "       ,...\n"
                                  "     ],\n"
                                  "     \"valueBalance\" : x.xxx,      (numeric, optional) The net value of Orchard Actions in " +
            CURRENCY_UNIT + "\n"
                            "     \"valueBalanceZat\" : n,       (numeric, optional) The net value of Orchard Actions in " +
            MINOR_CURRENCY_UNIT + "\n"
                                  "     \"flags\" : { (optional)\n"
